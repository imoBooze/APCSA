...
public class Review {
  ...
  /**
   * returns a string containing all of the text in fileName (including punctuation), with words
  ...
  /**
   * @returns the sentiment value of word as a number between -1 (very negative) to 1 (very positive
   *     sentiment)
   */

public class Elby {
  ...
  public String getResponse(String statement) {
    ...
    if (findKeyword(statement, "no", 0) >= 0) {
      ...
      response = "Tell me more about your family.";
        ...
        && findKeyword(statement, "me", statement.indexOf("you") + "you".length()) >= 0) {
      response = transformYouMeStatement(statement);
    } else if (findKeyword(statement, "I", 0) >= 0
        && findKeyword(statement, "you", statement.indexOf("I") + "I".length()) >= 0) {
  ...
  public String transformYouMeStatement(String statement) {
    ...
    int posOfMe = findKeyword(statement, "me", posOfYou + "you".length());

    String restOfStatement = statement.substring(posOfYou + "you".length(), posOfMe).trim();
  ...
  public String transformIWantStatement(String statement) {
    ...
    String restOfStatement = statement.substring(pos + "I want".length()).trim();
  ...
  public String transformIMeStatement(String statement) {
    ...
    int posOfYou = findKeyword(statement, "you", posOfI + "I".length());

    String restOfStatement = statement.substring(posOfI + "I".length(), posOfYou).trim();
